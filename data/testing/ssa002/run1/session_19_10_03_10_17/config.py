...
initialPos1 = Point3(52,4,0.8)
initialPos2 = Point3(4,24,0.8)
initialPos3 = Point3(52,32,0.8)
initialPos4 = Point3(32,4,0.8)
initialPos5 = Point3(20,52,0.8)
initialPos6 = Point3(36,52,0.8)
initialPos7 = Point3(20,48,0.8)
initialPos8 = Point3(4,52,0.8)
initialPos9 = Point3(52,40,0.8)
initialPos10 = Point3(32,4,0.8)
initialPos11 = Point3(12,4,0.8)
initialPos12 = Point3(24,52,0.8)
...
custLocs1 = [[48,4,270]]#location of custom goal for, e.g., training
custLocs2 = [[4,28,180]]#location of custom goal for, e.g., training
custLocs3 = [[52,36,180]]#location of custom goal for, e.g., training
custLocs4 = [[28,4,270]]#location of custom goal for, e.g., training
custLocs5 = [[16,52,270]]#location of custom goal for, e.g., training
custLocs6 = [[36,48,0]]#location of custom goal for, e.g., training
custLocs7 = [[20,44,0]]#location of custom goal for, e.g., training
custLocs8 = [[4,48,0]]#location of custom goal for, e.g., training
custLocs9 = [[52,36,0]]#location of custom goal for, e.g., training
custLocs10 = [[36,4,90]]#location of custom goal for, e.g., training
custLocs11 = [[16,4,90]]#location of custom goal for, e.g., training
custLocs12 = [[20,52,270]]#location of custom goal for, e.g., training
custZ = 0.2
...
# Finish Line Barrier
barrLocs1 = [[48.5,4,270]]
barrLocs5 = [[16.5,52,270]]
barrLocs8 = [[4,48.5,0]]
barrLocs10 = [[35.5,4,90]]
barrLocs11 = [[15.5,4,90]]
barrLocs12 = [[20.5,52,270]]
barrZ = 0.2
